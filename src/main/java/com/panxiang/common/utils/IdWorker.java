 ...
 *
 * @author PAN XIANG
 * @date 2016年10月14日上午11:58:02
 *
 * @version 2.0
 */
public class IdWorker {
	private final static long twepoch = 5188834974657L;
	// 机器标识位数
	...
	public static long getId() {
		return new IdWorker(1, 8).nextId();
	}

	public static long getNumber() {
		String id = new IdWorker(1, 8).nextId() + "";
		long number = Long.parseLong(id.substring(id.length() - 8, id.length()));
		return number;
	}
