package com.panxiang.common.base.impl;
...
public class BaseDaoHibernate4<T> implements BaseDao<T> {
	...
	public void delete(Class<T> entityClazz,String content, Serializable id) {
		getSessionFactory().getCurrentSession().createQuery("delete " + entityClazz.getSimpleName() + " en where en."+content+" = ?0").setParameter("0", id).executeUpdate();
	}
